...
# Linea 4-8: DATABASE UTENTI (in produzione usare DB con password hashate)
USERS = {
    'admin': {'password': 'admin123', 'role': 'admin'},
    'operatore': {'password': 'operatore123', 'role': 'operator'}
}

# Linea 10-18: DECORATORE PER RICHIEDERE LOGIN
...
# Linea 19-27: DECORATORE PER RICHIEDERE PRIVILEGI ADMIN
